 ...
 */
 ...
 $app->get('/category/:name', function ($name) {
        ...
        if($name == "all"){
            ...
            $arr = DAOFactory::getCategoriesDAO()->queryByName($name);
            header("Content-Type: application/json");
            echo json_encode($arr);
        }
	
    });
 $app->get('/categoryById/:id', function ($id) {
        //echo "Hello, $name";
        //print all rows order by title
	$obj = DAOFactory::getCategoriesDAO()->load($id);
        header("Content-Type: application/json");
        //print_r($obj);
        echo json_encode($obj);
    });
    
 $app->get('/reviewsInfoByCategoryId/:id', function ($id) {
        //echo "Hello, $name";
        //print all rows order by title
	$obj = DAOFactory::getReviewsDAO()->queryByCategoryId2($id);
        header("Content-Type: application/json");
        //print_r($obj);
        echo json_encode($obj);
    });
