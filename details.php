        ...
        <div class="wrapper">
            <section id="pagecontainer">
                ...
                <div id="center">
                    ...
                    $arr = DAOFactory::getReviewsDAO()->load($_REQUEST['id']);
                    //print_r($arr);
                    echo $arr->description;
                    ?>                    
                    
                    <div id="ccc" class="col">
                            <h4 class="ban"><a href="details.php?id=<?=$row->id?>" class="ccc" data-alltitle="all community" data-cat="ccc"><span class="txt">Add Review<sup class="c"></sup></span></a></h4>
                        </div>
                </div>
